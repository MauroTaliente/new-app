...
3. **`react-i18n-generate`** — genera `i18n.generated.ts` e `i18n.runtime.generated.tsx` (`react33I18n`; exports `getInitialLocale` / `persistLocale` desde **i18n ≥ 0.0.4**; ICU con **`useTf`** desde **i18n ≥ 0.0.5**).
...
Hace falta tener los paquetes compilados (`dist/`). **`@react33/react-generate@0.0.5`** declara **`@react33/react-i18n@0.0.5`** para que `pnpm codegen` use el generador alineado.
