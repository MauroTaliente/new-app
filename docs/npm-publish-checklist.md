...
| 2 | `@react33/react-context` | `context` | — |
| 3 | `@react33/react-networking` | `networking` | helpers |
| 4 | `@react33/react-styles` | `styles` | helpers |
| 5 | `@react33/react-persistence` | `persistence` | helpers, networking |
| 6 | `@react33/react-theme` | `theme` | context, styles |
| 7 | `@react33/react-hooks` | `hooks` | helpers |
| 8 | `@react33/react-i18n` | `i18n` | helpers, persistence |
| 9 | `@react33/react-generate` | `lib-generate` | networking, styles |
| 10 | `@react33/react-ui-base` | `ui-base` | helpers, styles |
| 11 | `@react33/react-form` | `form` | context, helpers, hooks, networking, styles, ui-base |
| 12 | `@react33/react-ui` | `ui` | form, ui-base, hooks, networking, styles, helpers, context (+ Radix, etc.) |

**Nota:** `react-generate` vive en `packages/lib-generate`; el tarball se llama `react33-react-generate-*.tgz`.
...
| `styles` | `react33-react-styles-0.0.1.tgz` | 17 | `defaults/*.css`, `lib.config.schema.json`, `lib-styles.config.json`, README\* |
...
| `i18n` | `react33-react-i18n-0.0.1.tgz` | 16 | `lib-i18n.config.schema.json`, subpaths `next` / `next/server` en `dist` |
| `lib-generate` | `react33-react-generate-0.0.1.tgz` | 8 | solo `dist` + manifests + README\* (`files`: `["dist"]`) |
